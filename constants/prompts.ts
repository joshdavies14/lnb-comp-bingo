...
export const PROMPTS_LIST = [
    ...
    'Someone vibes with the sharks',
    // 'Kate says "6 7"',
    // 'Ivanna screams',
    'Someone wanders off before team photo',
    'The freshers make fun of Scott or Phoebe',
    // 'Someone gets Phoebe and Morgan mixed up',
    'Someone gets Jess and Willow mixed up',
    'The Welsh get patriotic',
    // 'Phoebe gets drunk',
    'Someone gets asked for safety pins',
    // 'Beginners do open quickstep in team match',
]
